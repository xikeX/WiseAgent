...
LastEditTime: 2024-09-19 23:50:34
...
class Monitor(BaseModel):
    ...
    def handle_report(self,agentdata:AgentData,message:ReportMessage):
        for reporter in self.reportor_list:
            if reporter.name in agentdata.report_ability and\
                any([key_word == message.report_type for key_word in reporter.map_key_words]):
