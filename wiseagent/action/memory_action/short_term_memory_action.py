...
LastEditTime: 2024-09-21 12:18:03
Description: 
"""
...
@singleton
class ShortTermMemoryAction(BaseMemoryAction):
    action_name: str = "ShortTermMemoryAction"
    action_type: str = "MemoryAtion"
    action_description: str = "Actions to manage short term memory"
